...
Increase garbage collection threshold so we can start faster without GC'ing
...
#+end_src
** IRC
liberachat-user: entilldaniel
documentation:  https://www.gnu.org/software/emacs/manual/html_node/erc/Keystroke-Summary.html
#+begin_src emacs-lisp
  (use-package erc)
#+end_src
* News
...
*** Folding
Using the kirigami package and treesit-fold to have frontends and
backends for folding the code predictably.
